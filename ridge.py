    ...
    try:
        ...
        for repeat in range(n_repeats_cv2):
            ...
            for train_idx, test_idx in outer_cv.split(X):
                ...
                # Inner CV
                best_alpha = alpha_range[0]  # Default to use first value
                best_score = -np.inf
                ...
                for alpha in alpha_range:
                    ...
                    # Use validation set AUC to select best alpha
                ...
                try:
                    coef_importance = calculate_coefficient_importance(final_model, X_rest)
                    feature_importance.append(coef_importance)
                except Exception as e:
                    print(f"Warning: Error calculating coefficient importance: {str(e)}")
        ...
        # Calculate average performance of inner CV
